...
const CHECKOUT_DGS_URL =
  process.env.CHECKOUT_DGS_URL ?? "http://checkout-dgs:4011/graphql";
...
console.log(`Composed subgraph: checkout -> ${CHECKOUT_DGS_URL}`);
